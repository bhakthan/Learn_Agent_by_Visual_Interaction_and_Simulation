...
const azureServiceDetails: ServiceDetails[] = [
  {
    ...
    description: 'Azure OpenAI provides access to OpenAI\'s powerful language models including GPT-4, GPT-3.5-Turbo, and Embeddings models with Azure security and compliance capabilities.',
    keyFeatures: [
