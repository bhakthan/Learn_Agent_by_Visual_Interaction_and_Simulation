...
"""
            ...
            return {
                ...
                'answer': final_answer if done else "No final answer reached.",
...
```"""
            ...
            return {
                ...
                'cycles': current_cycle,
                'result': final_result || 'No final result reached.',
                'history': context_history
            }
...
"""
                ...
                if overall_score > 0.85:
                    print(f"Quality threshold met after {iterations} iterations")
                    break
